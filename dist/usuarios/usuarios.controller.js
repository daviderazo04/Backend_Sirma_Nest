...
let UsuariosController = class UsuariosController {
    ...
    async login(userCorreo, userClave) {
        const usuario = await this.usuariosService.login(userCorreo, userClave);
        if (!usuario) {
            throw new common_1.HttpException({ message: 'Credenciales incorrectas o usuario inactivo' }, common_1.HttpStatus.UNAUTHORIZED);
        }
        return usuario;
    }
};
...
__decorate([
    ...
    __param(0, (0, common_1.Body)('userCorreo')),
    __param(1, (0, common_1.Body)('userClave')),
    __metadata("design:type", Function),
